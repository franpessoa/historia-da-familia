...
\usepackage{geometry}
\geometry{a5paper, left=3cm, right=1.7cm, bottom=2cm, top=2.5cm}
...
\begin{document}
\includepdf[landscape=true]{cover/out/cover.pdf}
...
\begin{center}
    ...
    {\fontspec{Chloe}\Huge\textbf{História da Família\\Parte II}}
    \vspace*{2\baselineskip}

    Vó Teresa

    \vspace{10\baselineskip}
    {\small Edição:\\Francisco Pessoa}
