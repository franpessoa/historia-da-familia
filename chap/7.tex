...
\begin{subfigure}[h]{0.4\linewidth}
    \centering
\includegraphics[width=\linewidth]{7/batismo-rescan.jpg}
\caption*{Batismo}
\end{subfigure}
\hfill
\begin{subfigure}[h]{0.4\linewidth}
    \centering
\includegraphics[width=1\linewidth]{7/1a-comunhão-rescan.jpg}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{7/procissão-rescan-edit.jpg}
