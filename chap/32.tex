...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/garimpo-1.png}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/garimpo-2.png}
\caption*{O garimpo}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/colheita-de-arroz.png}
\caption*{Colheita de arroz na Nazaré.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/bateia.png}
\caption*{Brincando na bateia.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/remando.png}
\caption*{Remando nas águas do Curral de Pedra.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/passeando-curral.png}
\caption*{Passeando no Curral de Pedra.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/fernando+vicente.png}
\caption*{Fernando e Vicente.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/paula+fernando+paulo.png}
\caption*{Paula e Fernando com Paulo.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/turma-wandinha.png}
\caption*{A turma de natação da Wandinha.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/páscoa.png}
\caption*{Dia de páscoa em Conceição.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/niver-vicente-sossego.png}
\caption*{Aniversário do Vicente no Sossego de Mamãe.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{32/palhaço-botafogo.png}
