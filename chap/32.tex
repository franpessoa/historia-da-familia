...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{32/garimpo-1-rescan.jpg}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/garimpo-2-melhor-edit.jpg}
\caption*{O garimpo}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{32/colheita-de-arroz-rescan-edit.jpg}
\caption*{Colheita de arroz na Nazaré.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{32/bateia-rescan-edit.jpg}
\caption*{Brincando na bateia.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{32/remando-rescan-edit.jpg}
\caption*{Remando nas águas do Curral de Pedra.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{32/passeando-curral-melhor.jpeg}
\caption*{Passeando no Curral de Pedra.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{32/fernando+vicente-melhor.jpeg}
\caption*{Fernando e Vicente.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{32/paula+fernando+paulo-melhor.jpeg}
\caption*{Paula e Fernando com Paulo.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{32/turma-wandinha-rescan-edit.jpg}
\caption*{A turma de natação da Wandinha.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{32/páscoa-rescan-edit.jpg}
\caption*{Dia de páscoa em Conceição.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{32/niver-vicente-sossego-melhor.jpeg}
\caption*{Aniversário do Vicente no Sossego de Mamãe.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{32/palhaço-botafogo-rescan-edit.jpg}
