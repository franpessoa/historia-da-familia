...
\centering
\includegraphics[width=0.8\linewidth]{31/praia- araguaia-2.png}
\caption*{As praias e as águas mornas do Araguaia.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{31/churras.png}
\caption*{Churrasco na coroa do rio.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{31/voadeira.png}
