...
\begin{figure}[H]
\centering
\includegraphics[width = 0.4\linewidth]{4/Tia Mariazinha-rescan.jpg}
...
E foi desse modo que uma noite, no meio do sono, fui despertada para viver uma experiência inesquecível: no quarto semi-iluminado por velas, uma porção de gente vestida de branco entrava para dançar e cantar ao redor da minha cama, ao som do batuque ritmado dos atabaques.
...
A casa era um sobrado sólido, de espessas paredes, e eu já adormecera no andar de cima.
