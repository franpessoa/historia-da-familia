...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{25/de-volta-rescan.jpg}
\caption*{De volta a Araraquara, com Tomaz.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{25/tomaz-melhor.jpg}
\caption*{Tomaz, aos oito meses.}
\end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=0.8\linewidth]{25/marcelo-mundo.jpg}
% \caption*{Marcelo chegando ao mundo.}
% \end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=0.8\linewidth]{25/no-colo.jpg}
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{25/marcelo-1o-ano-rescan-edit.jpg}
\caption*{Marcelo, no primeiro ano de vida.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{25/tomaz+marcelo-melhor.jpg}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{25/fernando-bebe-melhor.jpg}
\caption*{Fernando bebê.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{25/irmãos-rescan.jpg}
