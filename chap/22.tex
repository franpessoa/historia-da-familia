...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{22/guanayr-melhor-edit.jpg}
...
\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{22/paulo+bagual-rescan-edit.jpg}
\caption*{Paulo montando o bagual.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\linewidth]{22/bagual+felipe-rescan-edit.jpg}
