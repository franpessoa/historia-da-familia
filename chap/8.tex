...
\begin{figure}
\centering
\includegraphics[width = \linewidth]{8/totó-original-edit.jpg}
\caption*{Tio Totó.}
\end{figure}
...
Disso resultou que ninguém, como Tia Albina, desenvolveu tamanha competência em produzir refeições saborosas em tempo recorde. Havia uma janelinha estratégica na cozinha, de onde se via a entrada da fazenda.
...
\begin{figure}
\centering
\includegraphics[width = \linewidth]{8/tia-albina-rescan-edit.jpg}
...
\begin{figure}
\centering
\includegraphics[width = 0.8\linewidth]{8/zé+yolanda-melhor-edit.jpg}
...
\begin{figure}
\centering
\includegraphics[width = 0.6\linewidth]{8/no-jardim-original-edit.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width = \linewidth]{8/tias-no-noivado-rescan-edit.jpg}
