...
Uma semana antes do Natal, quando os tios do Rio anunciavam sua iminente chegada, sob o comando do tio Beppe, uma grande barraca de lona era erguida no local.
...
Nessa nostálgica trajetória, Tio Beppe, flutuando nos vapores do chope, ia se emocionando progressivamente até chegar à lembrança da ``nossa santa mãe'', referência que sempre fazia chegar lágrimas aos olhos de todos os machos da família, orador incluído.
...
Mais alguns \textit{hip-hurras}, aplausos e Tio Beppe, já recuperado do surto emocional, mas não da bebedeira, bradava seu grito carnavalesco predileto -- \textit{``Alalaô, ooô, ooô! Mas que calor, ooô,ooô!''}, -- e arrastando todo mundo para o cordão de que ele assumia o comando logístico–musical, punha-se a evoluir pela casa até cair semi-desmaiado em algum canto.
...
\begin{figure}
\centering
\includegraphics[width = 0.7\linewidth]{10/pepone-natal-melhor-edit.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = \linewidth]{10/tia-glória-melhorada-edit.jpg}
