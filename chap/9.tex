...
\begin{figure}
\centering
\includegraphics[width = \linewidth]{9/tias-1-rescan-edit.jpg}
...
O assoalho, que há muito apodrecera de ferrugem, fora habilidosamente substituído por tábuas de madeira por cujos vãos se acompanhava a passagem da estrada sob as rodas, vantagem que compensava de sobra os banhos que a tia levava quando atravessavam as poças de água ou lama.
...
\begin{figure}
\centering
\includegraphics[width = 0.7\linewidth]{9/pepone-melhor-edit.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width = \linewidth]{9/viagem-a-sepetiba-rescan-edit.jpg}
